    ...
    class Program
    {
        static void Main(string[] args)
        {
          ...
          */
            ...
            //to automatically generate ages of the students
            for (var i = 0; i < 20; i++)
            {
              students[i] = r.Next(18, 35);
              //Console.WriteLine(students[i]);
            }

            // Calculate the average
            double avg = students.Average();

            Console.WriteLine("The average age in this group of students is " + Convert.ToInt32(avg));
